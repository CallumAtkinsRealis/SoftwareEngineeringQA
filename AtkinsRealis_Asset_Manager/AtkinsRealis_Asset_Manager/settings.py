"""
Django settings for AtkinsRealis_Asset_Manager project.
...
ALLOWED_HOSTS = ['softwareengineeringqa.onrender.com', '127.0.0.1']
...
WSGI_APPLICATION = 'AtkinsRealis_Asset_Manager.wsgi.application'
